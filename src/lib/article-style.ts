...
2026년 3월 15일 열린 METIS BIG BOUNTY in CHANGWON.
블라인드 10K/20K, 엔티 20K 상황에서 남은 인원은 4명.
...
파이널 테이블은 8명으로 시작됐으며, 블라인드 50K/100K, 엔티 100K 상황에서 프리플랍 올인 승부가 펼쳐졌다.
...
- 각 섹션·문단·액션 목록은 반드시 줄바꿈으로 구분한다. 한 줄에 여러 섹션이나 문장을 이어 쓰지 않는다.
...
- 칩 금액·블라인드·엔티는 반드시 32K, 90K, 50K/100K, 100K처럼 K 단위로만 표기한다. 100000, 100,000 같은 숫자 표기는 사용하지 않는다.
